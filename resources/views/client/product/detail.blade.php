            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">{{ formatCurrency($product->price, 'đ') }}</div>
                        <p class="word-wrap-break">{{ $product->introduce }}</p>
                        <div class="d-flex flex-column">
                            <div class="product__details__quantity">
                                <div class="quantity">
                                    ...
                                    <label class="color-757575 quantity-current"><b>{{ $product->quantity }}</b> {{ __('sản phẩm có sẵn') }}</label>
                                </div>
                            </div>
